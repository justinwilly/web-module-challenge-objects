...
console.log(createMenuItem("Lobster Roll", 22, "Lunch"));
console.log(createMenuItem("Steak", 56, "Dinner"));
...
*/
reviews.push({name: 'Justin', rating: 4, feedback: 'Best beer in town and the fries were perfect, burger was little well done.'})
...
console.log(getLastReviewByIndex(reviews, 0))
